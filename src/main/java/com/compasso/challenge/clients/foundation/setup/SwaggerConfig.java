package com.compasso.challenge.clients.foundation.setup;
...
public class SwaggerConfig extends WebMvcConfigurationSupport {
    ...
    public Docket productApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.compasso.challenge.clients"))
                .paths(regex("/.*"))
                .build()
    ...
    private ApiInfo metaData() {
        return new ApiInfoBuilder()
                ...
                .description("\"REST API Application for clients management\"")
                .version("1.0.0")
